...
function RecipiesbyCategories () {
    ...
    let {data,isLoading,error}= useFetch(`https://www.themealdb.com/api/json/v1/1/filter.php?c=${strCategory}`);
        ...
        return(
            <div>
                <h1 className='font-Inter font-bold 
                        text-red-500 text-center text-xs'>RECIPIES BY CATEGORIES</h1>
                <div className='flex flex-wrap'>
                {categoryRecipeList && (categoryRecipeList.map((recipe) => <RecipeBox recipe={recipe} key={recipe.strCategory}/>))}
                </div>
